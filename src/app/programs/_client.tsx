  ...
  return (
    <>
      ...
      <main style={{ paddingTop: '68px' }}>
        ...
        <div style={{
          margin: '0 2.5rem',
          background: 'linear-gradient(135deg, rgba(0,200,255,0.08) 0%, rgba(0,200,255,0.04) 50%, rgba(255,107,43,0.03) 100%)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flex: 1 }}>
            ...
            <div>
              <div style={{
                ...
                All Tracks at <span style={{ color: 'var(--cyan)' }}>50% Off</span> — Limited Time
              </div>
              <p style={{ fontSize: '0.88rem', color: 'var(--muted)', lineHeight: 1.5, marginBottom: 0 }}>
                Every track is currently half the original price. Secure your spot before the offer ends.
              </p>
            </div>
          </div>
                    ...
                    <div>
                      ...
                      <div className="track-badges" style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', alignItems: 'center' }}>
                        ...
                        <span style={{
                          ...
                          fontSize: '0.68rem', fontWeight: 800, color: 'var(--cyan)',
