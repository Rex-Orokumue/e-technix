  ...
  return (
    <div style={{ maxWidth: '700px' }}>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-head)', fontWeight: 800, fontSize: '1.6rem', letterSpacing: '-0.02em' }}>
          Add Session
        </h1>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          ...
          <div>
            ...
            <input style={inputStyle} placeholder="~2h"
        ...
        <div>
          <label style={labelStyle}>Google Meet Link (upcoming)</label>
        ...
        <button type="submit" disabled={saving} style={{
          padding: '0.9rem', background: saving ? 'rgba(0,200,255,0.3)' : 'var(--cyan)',
